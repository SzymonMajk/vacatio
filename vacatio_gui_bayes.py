...
class App(Frame):
    ...
    def __init__(self, master=None):
        ...
        var4 = IntVar()
        var5 = IntVar()
        c1 = Checkbutton(root, text='Morze', variable=var1, onvalue=1, offvalue=0)
        c2 = Checkbutton(root, text='Wyspa', variable=var2, onvalue=1, offvalue=0)
        c3 = Checkbutton(root, text='Szlaki', variable=var3, onvalue=1, offvalue=0)
        c4 = Checkbutton(root, text='Swiatynie', variable=var4, onvalue=1, offvalue=0)
        c5 = Checkbutton(root, text='Swieze Powietrze', variable=var5, onvalue=1, offvalue=0)
        c1.pack()
        c2.pack()
        c3.pack()
        c4.pack()
